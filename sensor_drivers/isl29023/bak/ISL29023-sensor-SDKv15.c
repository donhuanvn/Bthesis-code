/**	Do Ngoc Nhuan, 25/10/2018 
 *	ISL29032 driver for nRF5 SDK version 15.0.0
 */
...
void isl29023_write(uint8_t *a_data, uint8_t a_length)
{
		...
		err_code = nrf_drv_twi_tx(&isl29023_m_twi, ISL29023_ADDR, a_data, a_length, false);
		APP_ERROR_CHECK(err_code);
}
...
void isl29023_read(uint8_t *a_data, uint8_t a_length, uint8_t reg_addr)
{
		...
		err_code = nrf_drv_twi_rx(&isl29023_m_twi, ISL29023_ADDR, a_data, a_length);
		APP_ERROR_CHECK(err_code);
		nrf_delay_ms(2);
}
/**
